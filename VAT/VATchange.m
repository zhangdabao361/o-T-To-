...
% 
%% Rscale
% % % psi = the resolution for scaling 
% % % eta = the radius of eta-neigbourhood 
...
true_mem = class;
mem = M;
fraction1 = ami(true_mem,mem)
%% accuracy
% fraction2 = accuracy(true_mem, mem)
%% adjrand
% fraction3 = adjrand(true_mem, mem)
